...
```
npm create cloudflare@latest -- --template=cloudflare/templates/old-base-8397
```

## Preview Deployment

A live public deployment of this template is available at [https://old-base-8397.templates.workers.dev](https://old-base-8397.templates.workers.dev)
